...
/**
 * Admin Login DTO (Data Transfer Object)
 *
 * This class defines the structure and validation rules for admin login requests.
 ...
 * Admin Login DTO
 *
 * Used for: POST /api/auth/admin/login
 */
 ...
 * Refresh Token DTO
 *
 * Used for: POST /api/auth/admin/refresh
 */
